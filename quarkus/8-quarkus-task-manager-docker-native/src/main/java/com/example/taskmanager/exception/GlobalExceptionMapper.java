...
/**
 * ============================================================
 * VERSION 4 — Gestion globale des erreurs
 * ============================================================
 * Concepts introduits :
 *   ✅ @Provider         → enregistrement auto dans JAX-RS
 *   ✅ ExceptionMapper   → intercepte toutes les exceptions
 *   ✅ Réponses JSON structurées (pas de stack traces)
 *
 * Équivalent Spring : @ControllerAdvice + @ExceptionHandler
 * ============================================================
 */
@Provider
